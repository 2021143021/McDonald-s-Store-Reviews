...
- 전체 28,570건에 대해 학습된 모델을 적용하여 **테스트 정확도: 92.36%**를 달성했습니다.
...
- 비록 내 코딩 실력과 지식이 부족해서 완성도 면에서는 아쉬운 부분도 있었지만, 이번 프로젝트를 통해 그동안 몰랐던 다양한 기술과 코딩 역량, 그리고 README 문서 작성법까지 새롭게 배울 수 있어서 매우 뜻깊은 경험이었다.  
  특히, 실력이나 지식이 부족하더라도 내가 평소에 가장 좋아하는 브랜드인 '맥도날드'라는 관심사를 주제로 끝까지 포기하지 않고 꾸준히 나아감으로써 결국 프로젝트를 끝까지 마무리할 수 있었다는 점에서 매우 뿌듯하고 속이 후련하다.  
  앞으로도 이런 경험을 바탕으로 더 나은 프로젝트를 만들어갈 수 있을 거라는 자신감도 얻게 되었다.
